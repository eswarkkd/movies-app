...
import {loadPlayingMovies} from '../actions/movies';
  ...
  render() {
    ...
    return (
      <div className="main_div">
		...
		<div className="heading_class"><h2>Playing Movies</h2></div>
			...
			{(this.props.page>0) ? <div className="loadmore_class"><input type="button" value="Load More ... " onClick={()=>{this.props.playingMovies(1)}} /></div> : ""}
...
const mapDispatchtoProps = (dispatch)=>{
	return{
		playingMovies:(loadmore_value)=>{loadPlayingMovies(dispatch,loadmore_value)},
	};
}
