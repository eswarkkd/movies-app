...
import {loadDramaMovies} from '../actions/movies';
  ...
  render() {
    ...
    return (
      <div className="main_div">
		...
		<div className="heading_class"><h2>Drama Movies</h2></div>
			...
			{(this.props.page>0) ? <div className="loadmore_class"><input type="button" value="Load More ... " onClick={()=>{this.props.dramaMovies(1)}} /></div> : ""}
...
const mapDispatchtoProps = (dispatch)=>{
	return{
		dramaMovies:(loadmore_value)=>{loadDramaMovies(dispatch,loadmore_value)},
	};
}
