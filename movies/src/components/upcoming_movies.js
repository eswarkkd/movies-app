...
import {loadUpcomingMovies} from '../actions/movies';
  ...
  render() {
    ...
    return (
      <div className="main_div">
		...
		<div className="heading_class"><h2>Upcoming Movies</h2></div>
			...
			{(this.props.page>0) ? <div className="loadmore_class"><input type="button" value="Load More ... " onClick={()=>{this.props.upcomingMovies(1)}} /></div> : ""}
...
const mapDispatchtoProps = (dispatch)=>{
	return{
		upcomingMovies:(loadmore_value)=>{loadUpcomingMovies(dispatch,loadmore_value)},
	};
}
