...
import {loadBestMovies} from '../actions/movies';
  ...
  render() {
    ...
    return (
      <div className="main_div">
		...
		<div className="heading_class"><h2>Best Movies 2018</h2></div>
			...
			{(this.props.page>0) ? <div className="loadmore_class"><input type="button" value="Load More ... " onClick={()=>{this.props.bestMovies(1)}} /></div> : ""}
...
const mapDispatchtoProps = (dispatch)=>{
	return{
		bestMovies:(loadmore_value)=>{loadBestMovies(dispatch,loadmore_value)},
	};
}
