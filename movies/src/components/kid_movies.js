...
import {loadKidMovies} from '../actions/movies';
  ...
  render() {
    ...
    return (
      <div className="main_div">
		...
		<div className="heading_class"><h2>Kid Movies</h2></div>
			...
			{(this.props.page>0) ? <div className="loadmore_class"><input type="button" value="Load More ... " onClick={()=>{this.props.kidMovies(1)}} /></div> : ""}
...
const mapDispatchtoProps = (dispatch)=>{
	return{
		kidMovies:(loadmore_value)=>{loadKidMovies(dispatch,loadmore_value)},
	};
}
