...
exports.best_movies = function(req,res){
	axios.get('https://api.themoviedb.org/3/discover/movie?api_key=3b650e38d9522f397218b352ef81afcd&language=en-'+req.body.language+'&page='+req.body.page+'&primary_release_year=2018&sort_by=popularity.desc')
	.then(response => { res.send(response.data); })
}
